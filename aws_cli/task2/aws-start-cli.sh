...
lc=$(aws autoscaling create-launch-configuration \
...
as=$(aws autoscaling create-auto-scaling-group \
...
sp_out=$(aws autoscaling put-scaling-policy \
...
sp_in=$(aws autoscaling put-scaling-policy \
--policy-name scalein-policy \
--auto-scaling-group-name web \
